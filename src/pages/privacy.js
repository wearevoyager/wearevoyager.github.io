          ...
          <Header/>
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:py-8 lg:px-8">
              <div className="text-lg mx-auto prose prose-indigo text-gray-500">
                ...
                <p>Our Company securely stores your data on Google Cloud Platform.</p>
                <p>Our Company will keep your personal data for as long as reasonably necessary to fulfill the purposes we collected it for, for instance, legal, tax, accounting, regulatory, and reporting requirements. Once this time period has expired, we will securely delete your data.</p>
                <h2>Marketing</h2>
                ...
                <p>You have the right at any time to stop Our Company from contacting you for marketing purposes</p>
                <p>If you no longer wish to be contacted for marketing purposes, please email privacy@wearevoyager.com</p>
                ...
                <p>If you would like to exercise any of these rights, please contact us at our email: privacy@wearevoyager.com</p>
                <h2>Cookies</h2>
                ...
                <p>Our Company keeps its privacy policy under regular review and places any updates on this web page. This privacy policy was last updated on 13 September 2021.</p>
                ...
                <p>Should you wish to report a complaint or if you feel that Our Company has not addressed your concern in a satisfactory manner, you may contact the Information Commissioner’s Office. You can report a concern by visiting the ICO website, ico.org.uk.</p>
              </div>
            </div>
            <Footer/>
            <CookieConsent
